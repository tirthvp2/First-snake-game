...
#     # tar_url="C:/DalleTrial/0.tar",  # Uses bracket expanding notation. This specifies to read all tars from 0000.tar to 9999.tar
#     # embeddings_url="path/or/url/to/embeddings/folder",     # Included if .npy files are not in webdataset. Left out or set to None otherwise
#     img_embeddings_url="C:/DalleTrial/train2014",
#     text_embeddings_url="C:/DalleTrial/annotations/captions_train2014.json",
#     num_workers=4,
#     batch_size=32,
#     # shard_width=4,                                         # If a file in the webdataset shard 3 is named 0003039.jpg, we know the shard width is 4 and the last three digits are the index
#     shuffle_num=200,                                       # Does a shuffle of the data with a buffer size of 200
...
COCODataset = CocoCaptions(root='C:/DalleTrial/train2014',
                           annFile='C:/DalleTrial/annotations/captions_train2014.json',
                           transform=transforms.PILToTensor())

dataloader = DataLoader(COCODataset,
                        batch_size=32,
                        num_workers=4,
...
for idx in dataloader.dataset.ids:
    img = dataloader.dataset.dataset.images.idx
...
# print(list_of_text)
# tokens = ['This', 'is', 'a', 'sample', 'string']
...
# print(list_of_image)
text_tensor = torch.stack(list_of_text_tensor)
...
images = image_tensor.cuda()  # {6, 3, 256, 256}
